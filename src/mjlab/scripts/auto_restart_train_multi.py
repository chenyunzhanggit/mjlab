...
def main():
    """Main entry point."""
    if len(sys.argv) < 2:
        print("Usage: python -m mjlab.scripts.auto_restart_train <task_id> [training_args...]")
        print("\nExample:")
        print("  python -m mjlab.scripts.auto_restart_train Mjlab-Tracking-Teleoperation-Unitree-G1 \\")
